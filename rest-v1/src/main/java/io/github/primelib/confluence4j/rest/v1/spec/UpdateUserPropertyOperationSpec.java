...
public class UpdateUserPropertyOperationSpec {
    /**
     ...
     */
    @NotNull 
    private UserPropertyUpdate body;

    /**
     * Constructs a validated instance of {@link UpdateUserPropertyOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public UpdateUserPropertyOperationSpec(Consumer<UpdateUserPropertyOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param body                 The user property to be updated.
     */
    @ApiStatus.Internal
    public UpdateUserPropertyOperationSpec(String userId, String key, UserPropertyUpdate body) {
        this.userId = userId;
        this.key = key;
        this.body = body;
