...
public class RemoveUserFromContentRestrictionOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link RemoveUserFromContentRestrictionOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public RemoveUserFromContentRestrictionOperationSpec(Consumer<RemoveUserFromContentRestrictionOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public RemoveUserFromContentRestrictionOperationSpec(String id, String operationKey, String key, String username, String accountId) {
        this.id = id;
