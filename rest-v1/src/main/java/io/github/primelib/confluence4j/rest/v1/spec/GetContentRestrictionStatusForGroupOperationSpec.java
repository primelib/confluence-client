...
public class GetContentRestrictionStatusForGroupOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetContentRestrictionStatusForGroupOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetContentRestrictionStatusForGroupOperationSpec(Consumer<GetContentRestrictionStatusForGroupOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param groupName            The name of the group to be queried for whether the content restriction applies to it.
     */
    @ApiStatus.Internal
    public GetContentRestrictionStatusForGroupOperationSpec(String id, String operationKey, String groupName) {
        this.id = id;
