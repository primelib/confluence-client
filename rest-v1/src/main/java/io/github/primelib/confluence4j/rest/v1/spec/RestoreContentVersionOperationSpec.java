...
public class RestoreContentVersionOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link RestoreContentVersionOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public RestoreContentVersionOperationSpec(Consumer<RestoreContentVersionOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param body                 The content version to be restored.
     ...
     */
    @ApiStatus.Internal
    public RestoreContentVersionOperationSpec(String id, VersionRestore body, List<String> expand) {
        this.id = id;
        this.body = body;
        this.expand = expand;
