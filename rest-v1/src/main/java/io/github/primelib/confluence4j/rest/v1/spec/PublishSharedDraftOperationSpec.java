...
/**
 * PublishSharedDraftSpec
 * <p>
 * Specification for the PublishSharedDraft operation.
 * <p>
...
public class PublishSharedDraftOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link PublishSharedDraftOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public PublishSharedDraftOperationSpec(Consumer<PublishSharedDraftOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public PublishSharedDraftOperationSpec(String draftId, ContentBlueprintDraft body, String status, List<String> expand) {
