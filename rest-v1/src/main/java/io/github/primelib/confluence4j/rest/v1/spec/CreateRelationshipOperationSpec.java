...
public class CreateRelationshipOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link CreateRelationshipOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public CreateRelationshipOperationSpec(Consumer<CreateRelationshipOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param relationName         The name of the relationship. This method supports the 'favourite' (i.e. 'save for later') relationship. You can also specify any other value for this parameter to create a custom relationship type.
     ...
     */
    @ApiStatus.Internal
    public CreateRelationshipOperationSpec(String relationName, String sourceType, String sourceKey, String targetType, String targetKey, String sourceStatus, String targetStatus, Integer sourceVersion, Integer targetVersion) {
