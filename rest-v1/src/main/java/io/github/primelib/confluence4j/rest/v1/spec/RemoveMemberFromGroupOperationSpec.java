...
/**
 * RemoveMemberFromGroupSpec
 * <p>
 * Specification for the RemoveMemberFromGroup operation.
 * <p>
...
public class RemoveMemberFromGroupOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link RemoveMemberFromGroupOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public RemoveMemberFromGroupOperationSpec(Consumer<RemoveMemberFromGroupOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public RemoveMemberFromGroupOperationSpec(String name, String key, String username, String accountId) {
        this.name = name;
        this.key = key;
