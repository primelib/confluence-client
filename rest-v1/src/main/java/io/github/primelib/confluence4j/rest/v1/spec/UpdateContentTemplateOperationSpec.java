...
public class UpdateContentTemplateOperationSpec {
     ...
     */
    @NotNull 
    private ContentTemplateUpdate body;

    /**
     * Constructs a validated instance of {@link UpdateContentTemplateOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public UpdateContentTemplateOperationSpec(Consumer<UpdateContentTemplateOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param body                 The updated content template.
     */
    @ApiStatus.Internal
    public UpdateContentTemplateOperationSpec(ContentTemplateUpdate body) {
        this.body = body;
