...
public class FindSourcesForTargetOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link FindSourcesForTargetOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public FindSourcesForTargetOperationSpec(Consumer<FindSourcesForTargetOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public FindSourcesForTargetOperationSpec(String relationName, String sourceType, String targetType, String targetKey, String sourceStatus, String targetStatus, Integer sourceVersion, Integer targetVersion, List<String> expand, Integer start, Integer limit) {
