...
/**
 * GetContentWatchStatusSpec
 * <p>
 * Specification for the GetContentWatchStatus operation.
 * <p>
...
public class GetContentWatchStatusOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetContentWatchStatusOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetContentWatchStatusOperationSpec(Consumer<GetContentWatchStatusOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param contentId            The ID of the content to be queried for whether the specified user is watching it.
     ...
     */
    @ApiStatus.Internal
    public GetContentWatchStatusOperationSpec(String contentId, String key, String username, String accountId) {
