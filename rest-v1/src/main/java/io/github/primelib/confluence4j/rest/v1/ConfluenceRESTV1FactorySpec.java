...
import io.github.primelib.confluence4j.rest.v1.auth.BasicAuthSpec;
import io.github.primelib.confluence4j.rest.v1.auth.BearerAuthSpec;
...
/**
 * A specification to construct a {@link ConfluenceRESTV1Api} instance.
 */
@Data
...
public final class ConfluenceRESTV1FactorySpec<T> extends FeignModuleSpec<ConfluenceRESTV1FactorySpec<T>> {

    /**
     * The name of the backend to use
     */
    @NotNull
    private String backendName = "confluence4j-rest-v1";
    ...
    /**
     * Constructs a validated implementation of {@link ConfluenceRESTV1Api}.
     *
     * @param spec the specification to process
     */
    @NotNull
    public ConfluenceRESTV1FactorySpec(@NotNull Consumer<ConfluenceRESTV1FactorySpec<T>> spec) {
        spec.accept(this);
        validate();
    }
    ...
    public void applySpec(ConfluenceRESTV1FactorySpec<?> spec) {
