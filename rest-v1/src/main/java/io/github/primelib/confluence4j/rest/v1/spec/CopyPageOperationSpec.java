 ...
 * CopyPageSpec
 * <p>
 * Specification for the CopyPage operation.
 * <p>
 * Copy single page
 */
@Getter
...
public class CopyPageOperationSpec {
    /**
     ...
     */
    @NotNull 
    private CopyPageRequest request;
    ...
    /**
     * Constructs a validated instance of {@link CopyPageOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public CopyPageOperationSpec(Consumer<CopyPageOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public CopyPageOperationSpec(String id, CopyPageRequest request, List<String> expand) {
        this.id = id;
