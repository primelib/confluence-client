...
/**
 * CreateOrUpdateAttachmentsSpec
 * <p>
 * Specification for the CreateOrUpdateAttachments operation.
 * <p>
...
public class CreateOrUpdateAttachmentsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link CreateOrUpdateAttachmentsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public CreateOrUpdateAttachmentsOperationSpec(Consumer<CreateOrUpdateAttachmentsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public CreateOrUpdateAttachmentsOperationSpec(String id, File _file, File minorEdit, String status, File comment) {
        this.id = id;
        this._file = _file;
