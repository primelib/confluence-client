...
public class ConnectModules {
    ...
    /**
     * A list of app modules in the same format as the {@code modules} property in the [app descriptor](https://developer.atlassian.com/cloud/confluence/app-descriptor/).
     */
     ...
     * @param modules A list of app modules in the same format as the {@code modules} property in the [app descriptor](https://developer.atlassian.com/cloud/confluence/app-descriptor/).
     */
    @ApiStatus.Internal
