...
public class ContentRestrictionArray {
     ...
     */
    @ApiStatus.Internal
    public ContentRestrictionArray(List<ContentRestriction> results, Integer start, Integer limit, Integer size, String restrictionsHash, Map<String, String> _links) {
