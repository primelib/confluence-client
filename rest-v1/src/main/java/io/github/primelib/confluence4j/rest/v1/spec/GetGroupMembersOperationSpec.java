...
public class GetGroupMembersOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetGroupMembersOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetGroupMembersOperationSpec(Consumer<GetGroupMembersOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param groupName            The name of the group to be queried for its members.
     ...
     */
    @ApiStatus.Internal
    public GetGroupMembersOperationSpec(String groupName, Integer start, Integer limit) {
