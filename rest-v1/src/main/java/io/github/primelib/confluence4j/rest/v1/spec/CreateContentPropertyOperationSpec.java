...
public class CreateContentPropertyOperationSpec {
     ...
     */
    @NotNull 
    private ContentPropertyCreate body;

    /**
     * Constructs a validated instance of {@link CreateContentPropertyOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public CreateContentPropertyOperationSpec(Consumer<CreateContentPropertyOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public CreateContentPropertyOperationSpec(String id, ContentPropertyCreate body) {
        this.id = id;
        this.body = body;
