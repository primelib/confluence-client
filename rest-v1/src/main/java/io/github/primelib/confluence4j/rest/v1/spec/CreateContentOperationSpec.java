 ...
 * CreateContentSpec
 * <p>
 * Specification for the CreateContent operation.
 * <p>
 * Create content
 */
@Getter
...
public class CreateContentOperationSpec {
    /**
    ...
    /**
     * The new content to be created. Set the {@code representation} to the name of the body format type. For example, if you use {@code storage} for the body format, set '{@code representation}={@code storage}'. See [Confluence storage format](https://confluence.atlassian.com/x/AJkiLw).
     * If you are not sure how to generate the different formats, you can create a page in the Confluence application, retrieve the content using [Get content](#api-content-get), and expand the desired content format, e.g. {@code expand=body.storage}.
     */
    @NotNull 
    private ContentCreate content;
    ...
    /**
     * Constructs a validated instance of {@link CreateContentOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public CreateContentOperationSpec(Consumer<CreateContentOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public CreateContentOperationSpec(ContentCreate content, String status, List<String> expand) {
