...
public class AddContentWatcherOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link AddContentWatcherOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public AddContentWatcherOperationSpec(Consumer<AddContentWatcherOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public AddContentWatcherOperationSpec(String contentId, String key, String username, String accountId) {
