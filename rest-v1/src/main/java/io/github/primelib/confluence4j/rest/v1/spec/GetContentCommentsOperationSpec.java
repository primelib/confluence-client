...
public class GetContentCommentsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetContentCommentsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetContentCommentsOperationSpec(Consumer<GetContentCommentsOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param id                   The ID of the content to be queried for its comments.
     ...
     * @param start                The starting index of the returned comments.
     * @param limit                The maximum number of comments to return per page. Note, this may be restricted by fixed system limits.
     * @param location             The location of the comments in the page. Multiple locations can be specified. If no location is specified, comments from all locations are returned.
     * @param depth                Currently, this parameter is not used. Comments are returned at the root level only.
     */
    @ApiStatus.Internal
    public GetContentCommentsOperationSpec(String id, List<String> expand, Integer parentVersion, Integer start, Integer limit, List<String> location, String depth) {
        this.id = id;
        this.expand = expand;
