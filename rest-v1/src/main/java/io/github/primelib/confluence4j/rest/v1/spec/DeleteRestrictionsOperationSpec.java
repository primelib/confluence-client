...
/**
 * DeleteRestrictionsSpec
 * <p>
 * Specification for the DeleteRestrictions operation.
 * <p>
 * Delete restrictions
 */
@Getter
...
public class DeleteRestrictionsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link DeleteRestrictionsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public DeleteRestrictionsOperationSpec(Consumer<DeleteRestrictionsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public DeleteRestrictionsOperationSpec(String id, List<String> expand) {
        this.id = id;
        this.expand = expand;
