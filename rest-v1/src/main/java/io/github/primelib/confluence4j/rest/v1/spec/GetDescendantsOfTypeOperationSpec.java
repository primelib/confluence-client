...
/**
 * GetDescendantsOfTypeSpec
 * <p>
 * Specification for the GetDescendantsOfType operation.
 * <p>
...
public class GetDescendantsOfTypeOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetDescendantsOfTypeOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetDescendantsOfTypeOperationSpec(Consumer<GetDescendantsOfTypeOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetDescendantsOfTypeOperationSpec(String id, String type, String depth, List<String> expand, Integer start, Integer limit) {
        this.id = id;
        this.type = type;
        this.depth = depth;
        this.expand = expand;
