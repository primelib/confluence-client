...
/**
 * GetAuditRecordsForTimePeriodSpec
 * <p>
 * Specification for the GetAuditRecordsForTimePeriod operation.
 * <p>
...
public class GetAuditRecordsForTimePeriodOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetAuditRecordsForTimePeriodOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetAuditRecordsForTimePeriodOperationSpec(Consumer<GetAuditRecordsForTimePeriodOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetAuditRecordsForTimePeriodOperationSpec(Long number, String units, String searchString, Integer start, Integer limit) {
        this.number = number;
        this.units = units;
