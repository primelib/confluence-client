...
public class RemoveGroupFromContentRestrictionOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link RemoveGroupFromContentRestrictionOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public RemoveGroupFromContentRestrictionOperationSpec(Consumer<RemoveGroupFromContentRestrictionOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public RemoveGroupFromContentRestrictionOperationSpec(String id, String operationKey, String groupId) {
        this.id = id;
