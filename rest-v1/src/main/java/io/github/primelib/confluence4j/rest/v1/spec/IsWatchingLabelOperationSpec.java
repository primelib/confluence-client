 ...
 * IsWatchingLabelSpec
 * <p>
 * Specification for the IsWatchingLabel operation.
 * <p>
...
public class IsWatchingLabelOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link IsWatchingLabelOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public IsWatchingLabelOperationSpec(Consumer<IsWatchingLabelOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param labelName            The name of the label to be queried for whether the specified user is watching it.
     ...
     */
    @ApiStatus.Internal
    public IsWatchingLabelOperationSpec(String labelName, String key, String username, String accountId) {
