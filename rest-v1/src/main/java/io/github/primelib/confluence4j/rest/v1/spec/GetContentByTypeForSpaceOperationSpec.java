...
/**
 * GetContentByTypeForSpaceSpec
 * <p>
 * Specification for the GetContentByTypeForSpace operation.
 * <p>
...
public class GetContentByTypeForSpaceOperationSpec {
    /**
    ...
    /**
     * The type of content to return. {@code page}, {@code blogpost}, {@code &amp;lt;some_customContentType&amp;gt;}.
     */
    @NotNull 
    private String type;
    ...
    /**
     * Constructs a validated instance of {@link GetContentByTypeForSpaceOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetContentByTypeForSpaceOperationSpec(Consumer<GetContentByTypeForSpaceOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param type                 The type of content to return. {@code page}, {@code blogpost}, {@code &amp;lt;some_customContentType&amp;gt;}.
     ...
     */
    @ApiStatus.Internal
    public GetContentByTypeForSpaceOperationSpec(String spaceKey, String type, String depth, List<String> expand, Integer start, Integer limit) {
