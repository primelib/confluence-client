...
public class ConfluenceRestClientSpacePermissionsConsumerApi {
    private final ConfluenceRestClientSpacePermissionsApi api;

    public ConfluenceRestClientSpacePermissionsConsumerApi(ConfluenceRestClientSpacePermissionsApi api) {
        this.api = api;
    }
