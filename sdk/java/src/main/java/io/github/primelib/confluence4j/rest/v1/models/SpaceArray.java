...
public class SpaceArray {
     ...
     */
    @ApiStatus.Internal
    public SpaceArray(List<Space> results, Integer start, Integer limit, Integer size, Map<String, Object> additionalLinks) {
     ...
     * @return this
     */
    public SpaceArray additionalLinks(Map<String, Object> additionalLinks) {
        this.additionalLinks = additionalLinks;
        return this;
    }
