...
public class SpacePermissionV2 {
     ...
     */
    @ApiStatus.Internal
    public SpacePermissionV2(Long id, PermissionSubject subject, SpacePermissionV2Operation operation, Map<String, Object> additionalLinks) {
        this.id = id;
     ...
     * @return operation
     */
    public SpacePermissionV2Operation operation() {
