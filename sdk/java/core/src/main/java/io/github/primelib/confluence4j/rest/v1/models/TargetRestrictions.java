 ...
 *
 */
@JsonTypeName("TargetRestrictions")
@JsonPropertyOrder({
    "read",
    "update",
...
public class TargetRestrictions {
    ...
    protected TargetRestrictionsExpandable additionalExpandable;

    @JsonProperty("_links")
    protected Map<String, Object> additionalLinks;

    /**
     * Constructs a validated instance of {@link TargetRestrictions}.
     *
     * @param spec the specification to process
     */
    public TargetRestrictions(Consumer<TargetRestrictions> spec) {
        super();
        spec.accept(this);
    }
     ...
     */
    @ApiStatus.Internal
    protected TargetRestrictions() {
    }

    /**
     * Constructs a validated instance of {@link TargetRestrictions}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #TargetRestrictions(Consumer)} instead.
     * @param read read
     * @param update update
     ...
     */
    @ApiStatus.Internal
    public TargetRestrictions(ContentRestriction read, ContentRestriction update, TargetRestrictionsExpandable additionalExpandable, Map<String, Object> additionalLinks) {
        this.read = read;
        this.update = update;
     ...
     * @return this
     */
    public TargetRestrictions read(ContentRestriction read) {
        this.read = read;
        return this;
    }
     ...
     * @return this
     */
    public TargetRestrictions update(ContentRestriction update) {
        this.update = update;
        return this;
    }
     ...
     */
    public TargetRestrictionsExpandable additionalExpandable() {
     ...
     * @return this
     */
    public TargetRestrictions additionalExpandable(TargetRestrictionsExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
        return this;
    }
     ...
     */
    @JsonProperty("_expandable")
    public TargetRestrictionsExpandable getAdditionalExpandable() {
        return this.additionalExpandable;
    }
     ...
     * @param additionalExpandable additionalExpandable
     */
    public void setAdditionalExpandable(TargetRestrictionsExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
    }
    /**
     ...
     * @return this
     */
    public TargetRestrictions additionalLinks(Map<String, Object> additionalLinks) {
        this.additionalLinks = additionalLinks;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        TargetRestrictions that = (TargetRestrictions) o;
        return
