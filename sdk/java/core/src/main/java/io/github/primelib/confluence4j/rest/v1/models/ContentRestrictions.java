 ...
 *
 */
@JsonTypeName("ContentRestrictions")
@JsonPropertyOrder({
    "read",
    "update",
...
public class ContentRestrictions {
    ...
    protected ContentRestrictionsExpandable additionalExpandable;
     ...
     */
    @ApiStatus.Internal
    public ContentRestrictions(ContentRestriction read, ContentRestriction update, ContentRestrictionsExpandable additionalExpandable, Map<String, Object> additionalLinks) {
        this.read = read;
        this.update = update;
     ...
     */
    public ContentRestrictionsExpandable additionalExpandable() {
     ...
     * @return this
     */
    public ContentRestrictions additionalExpandable(ContentRestrictionsExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
        return this;
    }
     ...
     */
    @JsonProperty("_expandable")
    public ContentRestrictionsExpandable getAdditionalExpandable() {
        return this.additionalExpandable;
    }
     ...
     * @param additionalExpandable additionalExpandable
     */
    public void setAdditionalExpandable(ContentRestrictionsExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
    }
    /**
     ...
     * @return this
     */
    public ContentRestrictions additionalLinks(Map<String, Object> additionalLinks) {
        this.additionalLinks = additionalLinks;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        ContentRestrictions that = (ContentRestrictions) o;
        return
