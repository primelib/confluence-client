 ...
 *
 */
@JsonTypeName("ContentCreateSpace")
@JsonPropertyOrder({
    "id",
    "name",
    "icon",
...
Representation of a blogpost (content)
     ...
     * @return description
     */
    public ContentCreateSpaceDescription description() {
     ...
     * @return metadata
     */
    public ContentCreateSpaceMetadata metadata() {
    ...
    public boolean equals(Object o) {
        ...
        ContentCreateSpace that = (ContentCreateSpace) o;
        return
