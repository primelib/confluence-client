 ...
 *
 */
@JsonTypeName("SourceDescription")
@JsonPropertyOrder({
    "plain",
    "view",
...
public class SourceDescription {
    ...
    protected SourceDescriptionExpandable additionalExpandable;

    /**
     * Constructs a validated instance of {@link SourceDescription}.
     *
     * @param spec the specification to process
     */
    public SourceDescription(Consumer<SourceDescription> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link SourceDescription}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #SourceDescription(Consumer)} instead.
     * @param plain plain
     * @param view view
     * @param additionalExpandable additionalExpandable
     */
    @ApiStatus.Internal
    public SourceDescription(Map<String, Object> plain, Map<String, Object> view, SourceDescriptionExpandable additionalExpandable) {
        this.plain = plain;
        this.view = view;
     ...
     * @return this
     */
    public SourceDescription plain(Map<String, Object> plain) {
        this.plain = plain;
        return this;
    }
     ...
     * @return this
     */
    public SourceDescription view(Map<String, Object> view) {
        this.view = view;
        return this;
    }
     ...
     */
    public SourceDescriptionExpandable additionalExpandable() {
     ...
     * @return this
     */
    public SourceDescription additionalExpandable(SourceDescriptionExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
        return this;
    }
     ...
     */
    @JsonProperty("_expandable")
    public SourceDescriptionExpandable getAdditionalExpandable() {
        return this.additionalExpandable;
    }
     ...
     * @param additionalExpandable additionalExpandable
     */
    public void setAdditionalExpandable(SourceDescriptionExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
    }
