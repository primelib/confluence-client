 ...
 *
 */
@JsonTypeName("ContentCreateSpaceDescription")
@JsonPropertyOrder({
    "plain",
    "view",
...
public class ContentCreateSpaceDescription {
    ...
    protected ContentCreateSpaceDescriptionExpandable additionalExpandable;
     ...
     */
    @ApiStatus.Internal
    public ContentCreateSpaceDescription(Map<String, Object> plain, Map<String, Object> view, ContentCreateSpaceDescriptionExpandable additionalExpandable) {
        this.plain = plain;
        this.view = view;
     ...
     * @return this
     */
    public ContentCreateSpaceDescription plain(Map<String, Object> plain) {
        this.plain = plain;
        return this;
    }
     ...
     * @return this
     */
    public ContentCreateSpaceDescription view(Map<String, Object> view) {
        this.view = view;
        return this;
    }
     ...
     */
    public ContentCreateSpaceDescriptionExpandable additionalExpandable() {
     ...
     * @return this
     */
    public ContentCreateSpaceDescription additionalExpandable(ContentCreateSpaceDescriptionExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
        return this;
    }
     ...
     */
    @JsonProperty("_expandable")
    public ContentCreateSpaceDescriptionExpandable getAdditionalExpandable() {
        return this.additionalExpandable;
    }
     ...
     * @param additionalExpandable additionalExpandable
     */
    public void setAdditionalExpandable(ContentCreateSpaceDescriptionExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
    }
    ...
    public boolean equals(Object o) {
        ...
        ContentCreateSpaceDescription that = (ContentCreateSpaceDescription) o;
        return
