...
public class ConfluenceClientConsumerApi {
    private final ConfluenceClientApi api;

    public ConfluenceClientConsumerApi(ConfluenceClientApi api) {
        this.api = api;
    }
    ...
    * Permission to view the content that the macro is in.
     *
     * API Method: GET /rest/api/content/{id}/history/{version}/macro/id/{macroId}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to view the content that the macro is in.
     *
     * API Method: GET /rest/api/content/{id}/history/{version}/macro/id/{macroId}/convert/{to}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
     *   <li>id: The ID for the content that contains the macro.</li>
    ...
    * Permission to view the content that the macro is in.
     *
     * API Method: GET /rest/api/content/{id}/history/{version}/macro/id/{macroId}/convert/async/{to}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
     *   <li>id: The ID for the content that contains the macro.</li>
    ...
    * Permission to update the content.
     *
     * API Method: POST /rest/api/content/{id}/label
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to update the content.
     *
     * API Method: DELETE /rest/api/content/{id}/label
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to update the content.
     *
     * API Method: DELETE /rest/api/content/{id}/label/{label}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
     *   <li>id: The ID of the content that the label will be removed from.</li>
    ...
    * otherwise 'Confluence Administrator' global permission is required.
     *
     * API Method: POST /rest/api/content/{id}/permission/check
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * If request specifies 'contentIdContext', 'View' permission for the space, and permission to view the content.
     *
     * API Method: POST /rest/api/contentbody/convert/async/{to}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * If request specifies 'contentIdContext', 'View' permission for the space, and permission to view the content.
     *
     * API Method: GET /rest/api/contentbody/convert/async/{id}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to access the Confluence site ('Can use' global permission).
     *
     * API Method: GET /rest/api/contentbody/convert/async/bulk/tasks
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * `contentIdContext` are present.
     *
     * API Method: POST /rest/api/contentbody/convert/async/bulk/tasks
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to access the Confluence site ('Can use' global permission).
     *
     * API Method: GET /rest/api/longtask
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to access the Confluence site ('Can use' global permission).
     *
     * API Method: GET /rest/api/longtask/{id}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to view both the target entity and source entity.
     *
     * API Method: GET /rest/api/relation/{relationName}/from/{sourceType}/{sourceKey}/to/{targetType}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to view both the target entity and source entity.
     *
     * API Method: GET /rest/api/relation/{relationName}/from/{sourceType}/{sourceKey}/to/{targetType}/{targetKey}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to access the Confluence site ('Can use' global permission).
     *
     * API Method: PUT /rest/api/relation/{relationName}/from/{sourceType}/{sourceKey}/to/{targetType}/{targetKey}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * relationships for any user.
     *
     * API Method: DELETE /rest/api/relation/{relationName}/from/{sourceType}/{sourceKey}/to/{targetType}/{targetKey}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to view both the target entity and source entity.
     *
     * API Method: GET /rest/api/relation/{relationName}/to/{targetType}/{targetKey}/from/{sourceType}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
     *   <li>relationName: The name of the relationship. This method supports relationships created via [Create relationship](#api-wiki-rest-api-relation-relationname-from-sourcetype-sourcekey-to-targettype-targetkey-put). Note, this method does not support 'like' or 'favourite' relationships.</li>
    ...
    * global permission to update a global template.
     *
     * API Method: PUT /rest/api/template
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * global permission to create a global template.
     *
     * API Method: POST /rest/api/template
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * to access the Confluence site ('Can use' global permission) to view global blueprints.
     *
     * API Method: GET /rest/api/template/blueprint
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * access the Confluence site ('Can use' global permission) to view global templates.
     *
     * API Method: GET /rest/api/template/page
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * access the Confluence site ('Can use' global permission) to view global templates.
     *
     * API Method: GET /rest/api/template/{contentTemplateId}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    *         global permission to delete a global template.
     *
     * API Method: DELETE /rest/api/template/{contentTemplateId}
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to access the Confluence site ('Can use' global permission).
     *
     * API Method: GET /rest/api/user/anonymous
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to access the Confluence site ('Can use' global permission).
     *
     * API Method: GET /rest/api/user/current
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
     *   <li>expand: A multi-value parameter indicating which properties of the user to expand.    - `operations` returns the operations that the user is allowed to do.   - `personalSpace` returns the user's personal space, if it exists.   - `isExternalCollaborator`(@deprecated) see `isGuest` in response to find out whether the user is a guest.</li>
    ...
    * Permission to access the Confluence site ('Can use' global permission).
     *
     * API Method: GET /rest/api/user/memberof
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
     *   <li>accountId: The account ID of the user. The accountId uniquely identifies the user across all Atlassian products. For example, `384093:32b4d9w0-f6a5-3535-11a3-9c8c88d10192`.</li>
    ...
    * Permission to access the Confluence site ('Can use' global permission).
     *
     * API Method: GET /rest/api/user/bulk
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to access the Confluence site ('Can use' global permission).
     *
     * API Method: GET /rest/api/user/email
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
    ...
    * Permission to access the Confluence site ('Can use' global permission).
     *
     * API Method: GET /rest/api/user/email/bulk
     *
     * @param spec a consumer that creates the payload for this operation. Supports the following properties:
     * <ul>
