...
public class LongTaskStatus {
     ...
     */
    @ApiStatus.Internal
    public LongTaskStatus(String ari, String id, LongTaskStatusName name, Long elapsedTime, Integer percentageComplete, Boolean successful, Boolean finished, List<Map<String, Object>> messages, String status, List<Map<String, Object>> errors, LongTaskStatusAdditionalDetails additionalDetails) {
        this.ari = ari;
        this.id = id;
        this.name = name;
     ...
     * @return name
     */
    public LongTaskStatusName name() {
        return this.name;
    }
     ...
     */
    public LongTaskStatusAdditionalDetails additionalDetails() {
