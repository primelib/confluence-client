...
public class WebResourceDependencies {
     ...
     */
    @ApiStatus.Internal
    public WebResourceDependencies(Map<String, Object> additionalExpandable, List<String> keys, List<String> contexts, WebResourceDependenciesUris uris, WebResourceDependenciesTags tags, SuperBatchWebResources superbatch) {
     ...
     * @return uris
     */
    public WebResourceDependenciesUris uris() {
        return this.uris;
    }
     ...
     * @return tags
     */
    public WebResourceDependenciesTags tags() {
        return this.tags;
    }
