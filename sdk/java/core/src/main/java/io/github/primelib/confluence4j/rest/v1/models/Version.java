...
Representation of a blogpost (content)
    ...
    protected VersionExpandable additionalExpandable;
...
Representation of a blogpost (content)
     ...
     */
    @ApiStatus.Internal
    public Version(Map<String, Object> by, Instant when, String friendlyWhen, String message, Integer number, Boolean minorEdit, Content content, Map<String, Object> collaborators, VersionExpandable additionalExpandable, Map<String, Object> additionalLinks, Boolean contentTypeModified, String confRev, String syncRev, String syncRevSource) {
        this.by = by;
        this.when = when;
     ...
     */
    public VersionExpandable additionalExpandable() {
     ...
     * @return this
     */
    public Version additionalExpandable(VersionExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
        return this;
    }
     ...
     */
    @JsonProperty("_expandable")
    public VersionExpandable getAdditionalExpandable() {
        return this.additionalExpandable;
    }
     ...
     * @param additionalExpandable additionalExpandable
     */
    public void setAdditionalExpandable(VersionExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
    }
    /**
