...
/**
 * ConfluenceClientGroupConsumerApi
 *
...
public class ConfluenceClientGroupConsumerApi {
    private final ConfluenceClientGroupApi api;

    public ConfluenceClientGroupConsumerApi(ConfluenceClientGroupApi api) {
        this.api = api;
    }
