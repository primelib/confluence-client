...
public class Source {
    ...
    protected SourceHistory history;
...
or a page/blog post (containing an attachment or comment)
    ...
    @JsonProperty("body")
    protected SourceBody body;

    @JsonProperty("restrictions")
    protected SourceRestrictions restrictions;
    ...
    protected SourceExpandable additionalExpandable;
...
For example, `384093:32b4d9w0-f6a5-3535-11a3-9c8c88d10192`.
    ...
    protected SourceDescription description;
...
Representation of a blogpost (content)
    ...
    /**
     * Constructs a validated instance of {@link Source}.
     *
     ...
     * Constructs a validated instance of {@link Source}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #Source(Consumer)} instead.
     * @param id id
     * @param type type
     * @param status status
     * @param title title
...
Representation of a blogpost (content)
     ...
     */
    @ApiStatus.Internal
    public Source(Long id, String type, String status, String title, Space space, SourceHistory history, Version version, List<Content> ancestors, List<OperationCheckResult> operations, Map<String, Object> children, Map<String, Object> childTypes, Map<String, Object> descendants, Map<String, Object> container, SourceBody body, SourceRestrictions restrictions, SourceMetadata metadata, Map<String, Object> macroRenderedOutput, Object extensions, SourceExpandable additionalExpandable, Map<String, Object> additionalLinks, String ari, String base64EncodedAri, String username, String userKey, String accountId, String accountType, String email, String publicName, Icon profilePicture, String displayName, String timeZone, Boolean externalCollaborator, Boolean isExternalCollaborator, Boolean isGuest, UserDetails details, Space personalSpace, String key, String alias, String name, Icon icon, SourceDescription description, Content homepage, List<SpacePermission> permissions, SpaceSettings settings, Theme theme, LookAndFeel lookAndFeel) {
        this.id = id;
        this.type = type;
        this.status = status;
        this.title = title;
     ...
     * @return this
     */
    public Source history(SourceHistory history) {
        this.history = history;
        return this;
    }
     ...
     */
    @JsonProperty("history")
    public SourceHistory getHistory() {
        return this.history;
    }
     ...
     * @param history history
     */
    public void setHistory(SourceHistory history) {
        this.history = history;
    }
    /**
     ...
     * @return this
     */
    public Source body(SourceBody body) {
        this.body = body;
        return this;
    }
     ...
     * @param body body
     */
    public void setBody(SourceBody body) {
        this.body = body;
    }
    /**
     ...
     * @return restrictions
     */
    public SourceRestrictions restrictions() {
     ...
     * @return this
     */
    public Source restrictions(SourceRestrictions restrictions) {
        this.restrictions = restrictions;
        return this;
    }
     ...
     */
    @JsonProperty("restrictions")
    public SourceRestrictions getRestrictions() {
        return this.restrictions;
    }
     ...
     * @param restrictions restrictions
     */
    public void setRestrictions(SourceRestrictions restrictions) {
        this.restrictions = restrictions;
    }
    /**
     ...
     */
    public SourceExpandable additionalExpandable() {
     ...
     * @return this
     */
    public Source additionalExpandable(SourceExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
        return this;
    }
     ...
     */
    @JsonProperty("_expandable")
    public SourceExpandable getAdditionalExpandable() {
        return this.additionalExpandable;
    }
     ...
     * @param additionalExpandable additionalExpandable
     */
    public void setAdditionalExpandable(SourceExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
    }
    /**
     ...
     * @return description
     */
    public SourceDescription description() {
     ...
     * @return this
     */
    public Source description(SourceDescription description) {
        this.description = description;
        return this;
    }
     ...
     * @param description description
     */
    public void setDescription(SourceDescription description) {
        this.description = description;
    }
    /**
