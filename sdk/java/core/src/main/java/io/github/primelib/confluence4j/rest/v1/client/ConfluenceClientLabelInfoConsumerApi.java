...
/**
 * ConfluenceClientLabelInfoConsumerApi
 */
@Generated(value = "io.github.primelib.primecodegen")
public class ConfluenceClientLabelInfoConsumerApi {
    private final ConfluenceClientLabelInfoApi api;

    public ConfluenceClientLabelInfoConsumerApi(ConfluenceClientLabelInfoApi api) {
        this.api = api;
    }
