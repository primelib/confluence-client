...
/**
 * RelationTargetRestrictions
 *
 */
@JsonTypeName("RelationTargetRestrictions")
@JsonPropertyOrder({
    "read",
    "update",
...
public class RelationTargetRestrictions {
    ...
    protected RelationTargetRestrictionsExpandable additionalExpandable;

    @JsonProperty("_links")
    protected Map<String, Object> additionalLinks;

    /**
     * Constructs a validated instance of {@link RelationTargetRestrictions}.
     *
     * @param spec the specification to process
     */
    public RelationTargetRestrictions(Consumer<RelationTargetRestrictions> spec) {
        super();
        spec.accept(this);
    }
     ...
     */
    @ApiStatus.Internal
    protected RelationTargetRestrictions() {
    }

    /**
     * Constructs a validated instance of {@link RelationTargetRestrictions}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #RelationTargetRestrictions(Consumer)} instead.
     * @param read read
     * @param update update
     ...
     */
    @ApiStatus.Internal
    public RelationTargetRestrictions(ContentRestriction read, ContentRestriction update, RelationTargetRestrictionsExpandable additionalExpandable, Map<String, Object> additionalLinks) {
        this.read = read;
        this.update = update;
     ...
     * @return this
     */
    public RelationTargetRestrictions read(ContentRestriction read) {
        this.read = read;
        return this;
    }
     ...
     * @return this
     */
    public RelationTargetRestrictions update(ContentRestriction update) {
        this.update = update;
        return this;
    }
     ...
     */
    public RelationTargetRestrictionsExpandable additionalExpandable() {
     ...
     * @return this
     */
    public RelationTargetRestrictions additionalExpandable(RelationTargetRestrictionsExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
        return this;
    }
     ...
     */
    @JsonProperty("_expandable")
    public RelationTargetRestrictionsExpandable getAdditionalExpandable() {
        return this.additionalExpandable;
    }
     ...
     * @param additionalExpandable additionalExpandable
     */
    public void setAdditionalExpandable(RelationTargetRestrictionsExpandable additionalExpandable) {
        this.additionalExpandable = additionalExpandable;
    }
    /**
     ...
     * @return this
     */
    public RelationTargetRestrictions additionalLinks(Map<String, Object> additionalLinks) {
        this.additionalLinks = additionalLinks;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        RelationTargetRestrictions that = (RelationTargetRestrictions) o;
        return
    ...
    public String toString() {
        return "RelationTargetRestrictions{" +
            "read=" + read + ", " + 
            "update=" + update + ", " + 
