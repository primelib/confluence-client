 ...
 * GetSpaceLabelsSpec
 * <p>
 * Specification for the GetSpaceLabels operation.
 * <p>
...
public class GetSpaceLabelsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetSpaceLabelsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetSpaceLabelsOperationSpec(Consumer<GetSpaceLabelsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetSpaceLabelsOperationSpec(Long id, String prefix, List<LabelSortOrder> sort, String cursor, Integer limit) {
        this.id = id;
        this.prefix = prefix;
        this.sort = sort;
        this.cursor = cursor;
