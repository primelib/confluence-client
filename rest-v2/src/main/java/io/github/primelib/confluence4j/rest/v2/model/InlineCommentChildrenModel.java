...
public class InlineCommentChildrenModel {
     ...
     */
    @ApiStatus.Internal
    public InlineCommentChildrenModel(Long id, ContentStatus status, String title, Long parentCommentId, Version version, BodyBulk body, InlineCommentResolutionStatus resolutionStatus, InlineCommentProperties properties, CommentLinks _links) {
        this.id = id;
        this.status = status;
        this.title = title;
