...
/**
 * GetSpacePermissionsSpec
 * <p>
 * Specification for the GetSpacePermissions operation.
 * <p>
...
public class GetSpacePermissionsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetSpacePermissionsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetSpacePermissionsOperationSpec(Consumer<GetSpacePermissionsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetSpacePermissionsOperationSpec(Long id, String cursor, Integer limit) {
        this.id = id;
        this.cursor = cursor;
        this.limit = limit;
