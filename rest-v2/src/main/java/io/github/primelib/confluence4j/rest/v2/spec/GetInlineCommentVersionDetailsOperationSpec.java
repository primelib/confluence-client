...
public class GetInlineCommentVersionDetailsOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetInlineCommentVersionDetailsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetInlineCommentVersionDetailsOperationSpec(Consumer<GetInlineCommentVersionDetailsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetInlineCommentVersionDetailsOperationSpec(Long id, Long versionNumber) {
        this.id = id;
