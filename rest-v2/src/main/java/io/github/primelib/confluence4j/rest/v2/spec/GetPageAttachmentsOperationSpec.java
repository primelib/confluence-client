...
public class GetPageAttachmentsOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public GetPageAttachmentsOperationSpec(Long id, AttachmentSortOrder sort, String cursor, List<String> status, String mediaType, String filename, Integer limit) {
        this.id = id;
        this.sort = sort;
        this.cursor = cursor;
        this.status = status;
