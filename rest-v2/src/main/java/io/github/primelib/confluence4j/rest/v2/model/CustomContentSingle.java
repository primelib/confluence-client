...
@JsonTypeName("CustomContentSingle")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class CustomContentSingle {
    ...
    @JsonProperty("body")
    protected CustomContentBodySingle body;
     ...
     */
    public CustomContentSingle(Consumer<CustomContentSingle> spec) {
        spec.accept(this);
    }
