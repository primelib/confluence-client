...
public class PageBulk {
     ...
     */
    @ApiStatus.Internal
    public PageBulk(String id, ContentStatus status, String title, String spaceId, String parentId, ContentType parentType, Integer position, String authorId, String ownerId, String lastOwnerId, OffsetDateTime createdAt, Version version, BodyBulk body, AbstractPageLinks _links) {
        this.id = id;
        this.status = status;
        this.title = title;
