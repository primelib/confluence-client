...
public class GetAttachmentVersionsOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetAttachmentVersionsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetAttachmentVersionsOperationSpec(Consumer<GetAttachmentVersionsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetAttachmentVersionsOperationSpec(String id, String cursor, Integer limit, VersionSortOrder sort) {
        this.id = id;
        this.cursor = cursor;
        this.limit = limit;
        this.sort = sort;
