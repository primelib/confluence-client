...
/**
 * GetAttachmentCommentsSpec
 * <p>
 * Specification for the GetAttachmentComments operation.
 * <p>
...
public class GetAttachmentCommentsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetAttachmentCommentsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetAttachmentCommentsOperationSpec(Consumer<GetAttachmentCommentsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetAttachmentCommentsOperationSpec(String id, PrimaryBodyRepresentation bodyFormat, String cursor, Integer limit, CommentSortOrder sort) {
        this.id = id;
