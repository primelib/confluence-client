...
public interface ConfluenceRESTV2Api {
    ...
    MultiEntityResultSpace getSpaces(@Param("ids") @Nullable List<Long> ids, @Param("keys") @Nullable List<String> keys, @Param("type") @Nullable String type, @Param("status") @Nullable String status, @Param("labels") @Nullable List<String> labels, @Param("favoritedBy") @Nullable String favoritedBy, @Param("notFavoritedBy") @Nullable String notFavoritedBy, @Param("sort") @Nullable SpaceSortOrder sort, @Param("descriptionFormat") @Nullable SpaceDescriptionBodyRepresentation descriptionFormat, @Param("includeIcon") @Nullable Boolean includeIcon, @Param("cursor") @Nullable String cursor, @Param("limit") @Nullable Integer limit);
    ...
    Task updateTask(@Param("id") @NotNull Long id, @NotNull UpdateTaskRequest updateTaskRequest, @Param("bodyFormat") @Nullable PrimaryBodyRepresentation bodyFormat);
