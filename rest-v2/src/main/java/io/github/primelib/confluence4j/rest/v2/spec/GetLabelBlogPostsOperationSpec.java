...
public class GetLabelBlogPostsOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public GetLabelBlogPostsOperationSpec(Long id, List<Long> spaceId, PrimaryBodyRepresentation bodyFormat, BlogPostSortOrder sort, String cursor, Integer limit) {
        this.id = id;
