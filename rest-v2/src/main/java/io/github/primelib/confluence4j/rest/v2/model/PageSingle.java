...
public class PageSingle {
     ...
     */
    @ApiStatus.Internal
    public PageSingle(Long id, ContentStatus status, String title, Long spaceId, Long parentId, ContentType parentType, Integer position, String authorId, OffsetDateTime createdAt, Version version, BodySingle body, AbstractPageLinks _links) {
        this.id = id;
        this.status = status;
        this.title = title;
