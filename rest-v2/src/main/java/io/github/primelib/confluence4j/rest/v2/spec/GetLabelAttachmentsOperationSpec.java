...
public class GetLabelAttachmentsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetLabelAttachmentsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetLabelAttachmentsOperationSpec(Consumer<GetLabelAttachmentsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetLabelAttachmentsOperationSpec(Long id, AttachmentSortOrder sort, String cursor, Integer limit, Boolean serializeIdsAsStrings) {
        this.id = id;
        this.sort = sort;
        this.cursor = cursor;
        this.limit = limit;
