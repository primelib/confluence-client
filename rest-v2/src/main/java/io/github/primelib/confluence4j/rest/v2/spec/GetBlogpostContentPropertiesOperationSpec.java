...
public class GetBlogpostContentPropertiesOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetBlogpostContentPropertiesOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetBlogpostContentPropertiesOperationSpec(Consumer<GetBlogpostContentPropertiesOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetBlogpostContentPropertiesOperationSpec(Long blogpostId, String key, ContentPropertySortOrder sort, String cursor, Integer limit, Boolean serializeIdsAsStrings) {
