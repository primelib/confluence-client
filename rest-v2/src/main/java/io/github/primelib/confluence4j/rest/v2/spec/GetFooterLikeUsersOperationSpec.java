...
/**
 * GetFooterLikeUsersSpec
 * <p>
 * Specification for the GetFooterLikeUsers operation.
 * <p>
...
public class GetFooterLikeUsersOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetFooterLikeUsersOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetFooterLikeUsersOperationSpec(Consumer<GetFooterLikeUsersOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetFooterLikeUsersOperationSpec(Long id, String cursor, Integer limit) {
        this.id = id;
        this.cursor = cursor;
        this.limit = limit;
