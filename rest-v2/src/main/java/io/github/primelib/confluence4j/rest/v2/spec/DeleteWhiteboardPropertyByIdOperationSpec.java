...
public class DeleteWhiteboardPropertyByIdOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link DeleteWhiteboardPropertyByIdOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public DeleteWhiteboardPropertyByIdOperationSpec(Consumer<DeleteWhiteboardPropertyByIdOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public DeleteWhiteboardPropertyByIdOperationSpec(Long whiteboardId, Long propertyId) {
