...
/**
 * GetFooterCommentChildrenSpec
 * <p>
 * Specification for the GetFooterCommentChildren operation.
 * <p>
...
public class GetFooterCommentChildrenOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetFooterCommentChildrenOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetFooterCommentChildrenOperationSpec(Consumer<GetFooterCommentChildrenOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetFooterCommentChildrenOperationSpec(Long id, PrimaryBodyRepresentation bodyFormat, CommentSortOrder sort, String cursor, Integer limit, Boolean serializeIdsAsStrings) {
        this.id = id;
