...
public class GetCustomContentByTypeOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public GetCustomContentByTypeOperationSpec(String type, List<Long> id, List<Long> spaceId, CustomContentSortOrder sort, String cursor, Integer limit, CustomContentBodyRepresentation bodyFormat) {
        this.type = type;
        this.id = id;
