...
@JsonTypeName("AttachmentVersion")
...
public class AttachmentVersion {
    ...
    protected VersionedEntity attachment;

    /**
     * Constructs a validated instance of {@link AttachmentVersion}.
     *
     * @param spec the specification to process
     */
    public AttachmentVersion(Consumer<AttachmentVersion> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link AttachmentVersion}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AttachmentVersion(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public AttachmentVersion(OffsetDateTime createdAt, String message, Integer number, Boolean minorEdit, String authorId, VersionedEntity attachment) {
