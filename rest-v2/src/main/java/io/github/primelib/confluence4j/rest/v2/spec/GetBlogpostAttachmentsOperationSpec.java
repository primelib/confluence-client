...
public class GetBlogpostAttachmentsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetBlogpostAttachmentsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetBlogpostAttachmentsOperationSpec(Consumer<GetBlogpostAttachmentsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetBlogpostAttachmentsOperationSpec(Long id, AttachmentSortOrder sort, String cursor, List<String> status, String mediaType, String filename, Integer limit, Boolean serializeIdsAsStrings) {
        this.id = id;
        this.sort = sort;
        this.cursor = cursor;
        this.status = status;
