...
public class GetBlogpostAttachmentsOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public GetBlogpostAttachmentsOperationSpec(Long id, AttachmentSortOrder sort, String cursor, List<String> status, String mediaType, String filename, Integer limit) {
        this.id = id;
        this.sort = sort;
        this.cursor = cursor;
        this.status = status;
