...
import io.github.primelib.confluence4j.rest.v2.auth.BasicAuthSpec;
import io.github.primelib.confluence4j.rest.v2.auth.BearerAuthSpec;
...
/**
 * A specification to construct a {@link ConfluenceRESTV2Api} instance.
 */
@Data
...
public final class ConfluenceRESTV2FactorySpec<T> extends FeignModuleSpec<ConfluenceRESTV2FactorySpec<T>> {

    /**
     * The name of the backend to use
     */
    @NotNull
    private String backendName = "confluence4j-rest-v2";
    ...
    /**
     * Constructs a validated implementation of {@link ConfluenceRESTV2Api}.
     *
     * @param spec the specification to process
     */
    @NotNull
    public ConfluenceRESTV2FactorySpec(@NotNull Consumer<ConfluenceRESTV2FactorySpec<T>> spec) {
        spec.accept(this);
        validate();
    }
    ...
    public void applySpec(ConfluenceRESTV2FactorySpec<?> spec) {
