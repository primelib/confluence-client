...
public class GetCustomContentContentPropertiesOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public GetCustomContentContentPropertiesOperationSpec(Long customContentId, String key, ContentPropertySortOrder sort, String cursor, Integer limit, Boolean serializeIdsAsStrings) {
