...
/**
 * GetAttachmentLabelsSpec
 * <p>
 * Specification for the GetAttachmentLabels operation.
 * <p>
...
public class GetAttachmentLabelsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetAttachmentLabelsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetAttachmentLabelsOperationSpec(Consumer<GetAttachmentLabelsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetAttachmentLabelsOperationSpec(Long id, String prefix, List<LabelSortOrder> sort, String cursor, Integer limit, Boolean serializeIdsAsStrings) {
        this.id = id;
        this.prefix = prefix;
        this.sort = sort;
        this.cursor = cursor;
