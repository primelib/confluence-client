...
public class GetCustomContentAttachmentsOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public GetCustomContentAttachmentsOperationSpec(Long id, AttachmentSortOrder sort, String cursor, List<String> status, String mediaType, String filename, Integer limit, Boolean serializeIdsAsStrings) {
        this.id = id;
        this.sort = sort;
        this.cursor = cursor;
        this.status = status;
