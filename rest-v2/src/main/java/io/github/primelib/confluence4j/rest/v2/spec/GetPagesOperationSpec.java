...
public class GetPagesOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public GetPagesOperationSpec(List<Long> id, List<Long> spaceId, PageSortOrder sort, List<String> status, String title, PrimaryBodyRepresentation bodyFormat, String cursor, Integer limit) {
        this.id = id;
