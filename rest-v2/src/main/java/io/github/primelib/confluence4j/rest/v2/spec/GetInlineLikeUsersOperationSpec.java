...
/**
 * GetInlineLikeUsersSpec
 * <p>
 * Specification for the GetInlineLikeUsers operation.
 * <p>
...
public class GetInlineLikeUsersOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetInlineLikeUsersOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetInlineLikeUsersOperationSpec(Consumer<GetInlineLikeUsersOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetInlineLikeUsersOperationSpec(Long id, String cursor, Integer limit) {
        this.id = id;
        this.cursor = cursor;
        this.limit = limit;
