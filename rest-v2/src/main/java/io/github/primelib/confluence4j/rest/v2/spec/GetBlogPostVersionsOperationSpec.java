...
public class GetBlogPostVersionsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetBlogPostVersionsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetBlogPostVersionsOperationSpec(Consumer<GetBlogPostVersionsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetBlogPostVersionsOperationSpec(Long id, PrimaryBodyRepresentation bodyFormat, String cursor, Integer limit, VersionSortOrder sort) {
        this.id = id;
