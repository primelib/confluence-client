...
public class GetBlogPostInlineCommentsOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetBlogPostInlineCommentsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetBlogPostInlineCommentsOperationSpec(Consumer<GetBlogPostInlineCommentsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetBlogPostInlineCommentsOperationSpec(Long id, PrimaryBodyRepresentation bodyFormat, CommentSortOrder sort, String cursor, Integer limit, Boolean serializeIdsAsStrings) {
        this.id = id;
