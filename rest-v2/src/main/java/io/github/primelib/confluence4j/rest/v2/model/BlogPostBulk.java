...
public class BlogPostBulk {
     ...
     */
    @ApiStatus.Internal
    public BlogPostBulk(Long id, ContentStatus status, String title, Long spaceId, String authorId, OffsetDateTime createdAt, Version version, BodyBulk body, AbstractPageLinks _links) {
        this.id = id;
        this.status = status;
        this.title = title;
