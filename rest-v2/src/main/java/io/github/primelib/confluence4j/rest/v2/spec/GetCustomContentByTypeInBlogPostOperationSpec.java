...
public class GetCustomContentByTypeInBlogPostOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public GetCustomContentByTypeInBlogPostOperationSpec(Long id, String type, CustomContentSortOrder sort, String cursor, Integer limit, CustomContentBodyRepresentation bodyFormat, Boolean serializeIdsAsStrings) {
        this.id = id;
        this.type = type;
        this.sort = sort;
        this.cursor = cursor;
