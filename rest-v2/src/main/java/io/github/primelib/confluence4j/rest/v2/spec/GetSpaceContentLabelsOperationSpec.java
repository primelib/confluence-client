...
/**
 * GetSpaceContentLabelsSpec
 * <p>
 * Specification for the GetSpaceContentLabels operation.
 * <p>
...
public class GetSpaceContentLabelsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetSpaceContentLabelsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetSpaceContentLabelsOperationSpec(Consumer<GetSpaceContentLabelsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetSpaceContentLabelsOperationSpec(Long id, String prefix, List<LabelSortOrder> sort, String cursor, Integer limit) {
        this.id = id;
        this.prefix = prefix;
        this.sort = sort;
        this.cursor = cursor;
