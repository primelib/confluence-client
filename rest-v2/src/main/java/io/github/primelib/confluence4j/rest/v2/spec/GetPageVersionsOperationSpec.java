 ...
 * GetPageVersionsSpec
 * <p>
 * Specification for the GetPageVersions operation.
 * <p>
 * Get page versions
 */
@Getter
...
public class GetPageVersionsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetPageVersionsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetPageVersionsOperationSpec(Consumer<GetPageVersionsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetPageVersionsOperationSpec(Long id, PrimaryBodyRepresentation bodyFormat, String cursor, Integer limit, VersionSortOrder sort) {
        this.id = id;
