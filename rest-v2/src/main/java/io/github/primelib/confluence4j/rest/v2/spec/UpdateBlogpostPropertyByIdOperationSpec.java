...
public class UpdateBlogpostPropertyByIdOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public UpdateBlogpostPropertyByIdOperationSpec(Long blogpostId, Long propertyId, ContentPropertyUpdateRequest contentPropertyUpdateRequest, Boolean serializeIdsAsStrings) {
