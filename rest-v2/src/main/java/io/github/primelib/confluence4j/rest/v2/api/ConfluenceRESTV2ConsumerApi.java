...
public class ConfluenceRESTV2ConsumerApi {
    private final ConfluenceRESTV2Api api;

    public ConfluenceRESTV2ConsumerApi(ConfluenceRESTV2Api api) {
        this.api = api;
    }
     ...
     * </ul>
     */
    public CheckAccessByEmail200Response checkAccessByEmail(Consumer<CheckAccessByEmailOperationSpec> spec) {
     ...
     * </ul>
     */
    public ContentIdToContentTypeResponse convertContentIdsToContentTypes(Consumer<ConvertContentIdsToContentTypesOperationSpec> spec) {
    ...
    public void deleteAttachmentPropertyById(Consumer<DeleteAttachmentPropertyByIdOperationSpec> spec) {
        ...
        api.deleteAttachmentPropertyById(r.attachmentId(), r.propertyId());
    }
    ...
    public void deleteBlogpostPropertyById(Consumer<DeleteBlogpostPropertyByIdOperationSpec> spec) {
        ...
        api.deleteBlogpostPropertyById(r.blogpostId(), r.propertyId());
    }
    ...
    public void deleteCommentPropertyById(Consumer<DeleteCommentPropertyByIdOperationSpec> spec) {
        ...
        api.deleteCommentPropertyById(r.commentId(), r.propertyId());
    }
    ...
    public void deleteCustomContentPropertyById(Consumer<DeleteCustomContentPropertyByIdOperationSpec> spec) {
        ...
        api.deleteCustomContentPropertyById(r.customContentId(), r.propertyId());
    }
    ...
    public void deleteFooterComment(Consumer<DeleteFooterCommentOperationSpec> spec) {
        ...
        api.deleteFooterComment(r.commentId());
    }
    ...
    public void deleteInlineComment(Consumer<DeleteInlineCommentOperationSpec> spec) {
        ...
        api.deleteInlineComment(r.commentId());
    }
    ...
    public void deletePagePropertyById(Consumer<DeletePagePropertyByIdOperationSpec> spec) {
        ...
        api.deletePagePropertyById(r.pageId(), r.propertyId());
    }
     ...
     * </ul>
     */
    public MultiEntityResultAttachmentCommentModel getAttachmentComments(Consumer<GetAttachmentCommentsOperationSpec> spec) {
     ...
     * </ul>
     */
    public PermittedOperationsResponse getAttachmentOperations(Consumer<GetAttachmentOperationsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultVersion getAttachmentVersions(Consumer<GetAttachmentVersionsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultString getBlogPostLikeUsers(Consumer<GetBlogPostLikeUsersOperationSpec> spec) {
     ...
     * </ul>
     */
    public PermittedOperationsResponse getBlogPostOperations(Consumer<GetBlogPostOperationsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultVersion1 getBlogPostVersions(Consumer<GetBlogPostVersionsOperationSpec> spec) {
     ...
     * </ul>
     */
    public PermittedOperationsResponse getCustomContentOperations(Consumer<GetCustomContentOperationsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultVersion3 getCustomContentVersions(Consumer<GetCustomContentVersionsOperationSpec> spec) {
     ...
     * </ul>
     */
    public PermittedOperationsResponse getFooterCommentOperations(Consumer<GetFooterCommentOperationsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultVersion4 getFooterCommentVersions(Consumer<GetFooterCommentVersionsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultString getFooterLikeUsers(Consumer<GetFooterLikeUsersOperationSpec> spec) {
     ...
     * </ul>
     */
    public PermittedOperationsResponse getInlineCommentOperations(Consumer<GetInlineCommentOperationsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultVersion4 getInlineCommentVersions(Consumer<GetInlineCommentVersionsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultString getInlineLikeUsers(Consumer<GetInlineLikeUsersOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultLabel1 getLabels(Consumer<GetLabelsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultAncestor getPageAncestors(Consumer<GetPageAncestorsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultString getPageLikeUsers(Consumer<GetPageLikeUsersOperationSpec> spec) {
     ...
     * </ul>
     */
    public PermittedOperationsResponse getPageOperations(Consumer<GetPageOperationsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultVersion2 getPageVersions(Consumer<GetPageVersionsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultLabel getSpaceContentLabels(Consumer<GetSpaceContentLabelsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultLabel getSpaceLabels(Consumer<GetSpaceLabelsOperationSpec> spec) {
     ...
     * </ul>
     */
    public PermittedOperationsResponse getSpaceOperations(Consumer<GetSpaceOperationsOperationSpec> spec) {
     ...
     * </ul>
     */
    public MultiEntityResultSpacePermission getSpacePermissions(Consumer<GetSpacePermissionsOperationSpec> spec) {
    ...
    public void inviteByEmail(Consumer<InviteByEmailOperationSpec> spec) {
        ...
        api.inviteByEmail(r.checkAccessByEmailRequest());
    }
