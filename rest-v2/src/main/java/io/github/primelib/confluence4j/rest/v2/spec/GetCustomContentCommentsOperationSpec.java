...
/**
 * GetCustomContentCommentsSpec
 * <p>
 * Specification for the GetCustomContentComments operation.
 * <p>
...
public class GetCustomContentCommentsOperationSpec {
    /**
    ...
    /**
     * Maximum number of comments per result to return. If more results exist, use the {@code Link} header to retrieve a relative URL that will return the next set of results.
     */
    @Nullable 
    ...
    /**
     * Constructs a validated instance of {@link GetCustomContentCommentsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetCustomContentCommentsOperationSpec(Consumer<GetCustomContentCommentsOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param limit                Maximum number of comments per result to return. If more results exist, use the {@code Link} header to retrieve a relative URL that will return the next set of results.
     * @param sort                 Used to sort the result by a particular field.
     */
    @ApiStatus.Internal
    public GetCustomContentCommentsOperationSpec(Long id, PrimaryBodyRepresentation bodyFormat, String cursor, Integer limit, CommentSortOrder sort) {
        this.id = id;
