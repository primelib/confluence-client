...
/**
 * GetBlogPostFooterCommentsSpec
 * <p>
 * Specification for the GetBlogPostFooterComments operation.
 * <p>
...
public class GetBlogPostFooterCommentsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetBlogPostFooterCommentsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetBlogPostFooterCommentsOperationSpec(Consumer<GetBlogPostFooterCommentsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetBlogPostFooterCommentsOperationSpec(Long id, PrimaryBodyRepresentation bodyFormat, CommentSortOrder sort, String cursor, Integer limit, Boolean serializeIdsAsStrings) {
        this.id = id;
