...
public class GetCustomContentByTypeInPageOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public GetCustomContentByTypeInPageOperationSpec(Long id, String type, CustomContentSortOrder sort, String cursor, Integer limit, CustomContentBodyRepresentation bodyFormat) {
        this.id = id;
        this.type = type;
        this.sort = sort;
        this.cursor = cursor;
