...
/**
 * GetCustomContentByTypeInPageSpec
 * <p>
 * Specification for the GetCustomContentByTypeInPage operation.
 * <p>
...
public class GetCustomContentByTypeInPageOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetCustomContentByTypeInPageOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetCustomContentByTypeInPageOperationSpec(Consumer<GetCustomContentByTypeInPageOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetCustomContentByTypeInPageOperationSpec(Long id, String type, CustomContentSortOrder sort, String cursor, Integer limit, CustomContentBodyRepresentation bodyFormat, Boolean serializeIdsAsStrings) {
        this.id = id;
        this.type = type;
        this.sort = sort;
        this.cursor = cursor;
