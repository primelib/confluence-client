...
public class GetLabelsOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetLabelsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetLabelsOperationSpec(Consumer<GetLabelsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetLabelsOperationSpec(List<Long> labelId, List<String> prefix, String cursor, List<LabelSortOrder> sort, Integer limit) {
