...
/**
 * GetBlogPostLabelsSpec
 * <p>
 * Specification for the GetBlogPostLabels operation.
 * <p>
...
public class GetBlogPostLabelsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetBlogPostLabelsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetBlogPostLabelsOperationSpec(Consumer<GetBlogPostLabelsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetBlogPostLabelsOperationSpec(Long id, String prefix, List<LabelSortOrder> sort, String cursor, Integer limit, Boolean serializeIdsAsStrings) {
        this.id = id;
        this.prefix = prefix;
        this.sort = sort;
        this.cursor = cursor;
