...
public class GetFooterLikeCountOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetFooterLikeCountOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetFooterLikeCountOperationSpec(Consumer<GetFooterLikeCountOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetFooterLikeCountOperationSpec(Long id) {
        this.id = id;
