...
/**
 * UpdateSpacePropertyByIdSpec
 * <p>
 * Specification for the UpdateSpacePropertyById operation.
 * <p>
...
public class UpdateSpacePropertyByIdOperationSpec {
    /**
     ...
     */
    @NotNull 
    private SpacePropertyUpdateRequest spacePropertyUpdateRequest;
    ...
    /**
     * Constructs a validated instance of {@link UpdateSpacePropertyByIdOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public UpdateSpacePropertyByIdOperationSpec(Consumer<UpdateSpacePropertyByIdOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public UpdateSpacePropertyByIdOperationSpec(Long spaceId, Long propertyId, SpacePropertyUpdateRequest spacePropertyUpdateRequest, Boolean serializeIdsAsStrings) {
        this.spaceId = spaceId;
        this.propertyId = propertyId;
        this.spacePropertyUpdateRequest = spacePropertyUpdateRequest;
    ...
    public void validate() {
        ...
        Objects.requireNonNull(spacePropertyUpdateRequest, "spacePropertyUpdateRequest is a required parameter!");
    }
}
