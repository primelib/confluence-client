...
public class GetPageContentPropertiesOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public GetPageContentPropertiesOperationSpec(Long pageId, String key, ContentPropertySortOrder sort, String cursor, Integer limit, Boolean serializeIdsAsStrings) {
        this.pageId = pageId;
        this.key = key;
        this.sort = sort;
        this.cursor = cursor;
