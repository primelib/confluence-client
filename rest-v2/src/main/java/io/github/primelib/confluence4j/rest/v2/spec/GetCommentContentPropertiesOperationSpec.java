...
public class GetCommentContentPropertiesOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetCommentContentPropertiesOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetCommentContentPropertiesOperationSpec(Consumer<GetCommentContentPropertiesOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetCommentContentPropertiesOperationSpec(Long commentId, String key, ContentPropertySortOrder sort, String cursor, Integer limit, Boolean serializeIdsAsStrings) {
