...
public class GetLabelPagesOperationSpec {
     ...
     */
    @ApiStatus.Internal
    public GetLabelPagesOperationSpec(Long id, List<Long> spaceId, PrimaryBodyRepresentation bodyFormat, PageSortOrder sort, String cursor, Integer limit, Boolean serializeIdsAsStrings) {
        this.id = id;
