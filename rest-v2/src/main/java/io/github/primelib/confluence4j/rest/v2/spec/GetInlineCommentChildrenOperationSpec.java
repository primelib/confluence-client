...
/**
 * GetInlineCommentChildrenSpec
 * <p>
 * Specification for the GetInlineCommentChildren operation.
 * <p>
...
public class GetInlineCommentChildrenOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetInlineCommentChildrenOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetInlineCommentChildrenOperationSpec(Consumer<GetInlineCommentChildrenOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetInlineCommentChildrenOperationSpec(Long id, Boolean serializeIdsAsStrings, PrimaryBodyRepresentation bodyFormat, CommentSortOrder sort, String cursor, Integer limit) {
        this.id = id;
