...
projectConfiguration {
    ...
    artifactId.set("confluence4j-rest-v2")
    artifactDisplayName.set("confluence4j-rest-v2")
    artifactDescription.set("A Java Wrapper for the Confluence REST API")

    pom = { pom ->
        pom.url.set("https://github.com/primelib/confluence4j")
        pom.issueManagement {
            system.set("GitHub")
            url.set("https://github.com/primelib/confluence4j/issues")
        }
        ...
        pom.licenses {
            license {
                ...
                url.set("https://raw.githubusercontent.com/primelib/confluence4j/main/LICENSE")
            }
        }
        pom.scm {
            connection.set("scm:git:git://github.com/primelib/confluence4j.git")
            developerConnection.set("scm:git:git://github.com/primelib/confluence4j.git")
            url.set("https://github.com/primelib/confluence4j")
        }
    }
}
